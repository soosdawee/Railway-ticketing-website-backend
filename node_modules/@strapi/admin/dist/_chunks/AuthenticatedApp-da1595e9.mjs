...
import { u as useConfiguration, c as createTypedSelector, a as useTypedDispatch, b as useTypedSelector, A as ACTION_SET_APP_RUNTIME_STATUS, d as createRoute, R as RBACProvider, N as NpsSurvey } from "./index-b6ee936b.mjs";
...
const CM = React.lazy(
  ...
  () => import("./index-81509193.mjs").then((n) => n.i)
);
const HomePage = React.lazy(
  () => import("./HomePage-2690d237.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-3bd06321.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-95af86bb.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-b6ee936b.mjs").then((n) => n.Y).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-20de1b54.mjs").then((mod) => ({
...
const SettingsPage = React.lazy(
  () => (
    // @ts-expect-error – No types, yet.
    import("./index-f5b276a8.mjs").then((module) => ({
...
//# sourceMappingURL=AuthenticatedApp-da1595e9.mjs.map

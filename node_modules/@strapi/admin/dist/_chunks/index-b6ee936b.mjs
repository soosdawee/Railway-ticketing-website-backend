...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-8f68c65a.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-29d123f8.mjs")).FORMS,
    {
...
const AuthenticatedApp = React.lazy(
  () => import("./AuthenticatedApp-da1595e9.mjs").then((n) => n.A).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App = () => {
...
//# sourceMappingURL=index-b6ee936b.mjs.map

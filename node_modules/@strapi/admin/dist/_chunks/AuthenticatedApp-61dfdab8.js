...
const CM = React__namespace.lazy(
  ...
  () => Promise.resolve().then(() => require("./index-9304d6de.js")).then((n) => n.index)
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-48934b34.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-da0780c1.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-935fca72.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-0ed05075.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-b8b29c4d.js")).then((mod) => ({
...
const SettingsPage = React__namespace.lazy(
  () => (
    // @ts-expect-error – No types, yet.
    Promise.resolve().then(() => require("./index-5a5b0567.js")).then((module2) => ({
...
//# sourceMappingURL=AuthenticatedApp-61dfdab8.js.map

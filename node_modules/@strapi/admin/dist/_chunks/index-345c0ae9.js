...
const index$1 = require("./index-0ed05075.js");
const index$3 = require("./index-88298941.js");
const Icons = require("@strapi/icons");
const PropTypes = require("prop-types");
const v2 = require("@strapi/design-system/v2");
const formik = require("formik");
const index$2 = require("./index-f7dbd21b.js");
...
const ModalForm = ({ onSuccess, onToggle }) => {
  ...
  const MagicLink = index$1.useEnterprise(
    index$2.MagicLinkCE,
    async () => (await Promise.resolve().then(() => require("./index-e0e235a0.js"))).MagicLinkEE
  );
...
const UsersListPageSwitch = () => {
  const UsersListPage = index$1.useEnterprise(
    ...
    async () => (
      ...
      (await Promise.resolve().then(() => require("./index-2b22b1a0.js"))).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
exports.index = index;
//# sourceMappingURL=index-345c0ae9.js.map

...
import { g as getFullName, s as selectAdminPermissions } from "./AuthenticatedApp-da1595e9.mjs";
...
import { p as useEnterprise } from "./index-b6ee936b.mjs";
import { F as Filters } from "./index-74812118.mjs";
import { Envelop, Pencil, Trash } from "@strapi/icons";
import PropTypes from "prop-types";
import { Breadcrumbs, Crumb } from "@strapi/design-system/v2";
import { Formik } from "formik";
import { M as MagicLinkCE, S as SelectRoles } from "./index-be3e5f69.mjs";
...
const ModalForm = ({ onSuccess, onToggle }) => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import("./index-f52ae628.mjs")).MagicLinkEE
  );
...
const UsersListPageSwitch = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import("./index-6353193a.mjs")).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=index-a6f1ccf6.mjs.map
